module.exports = {
  ab: {
    ...
    subscribeLink: 'https://athleticbusiness.dragonforms.com/loading.do?omedasite=ab_pref',
  ...
  aqua: {
    brandName: 'Aqua',
    logo: {
      src: '/files/base/abmedia/all/image/static/AQUA_Today.png',
      footerWidth: 250,
    },
    advertiseLink: 'https://info.aquamagazine.com/',
    subscribeLink: 'https://athleticbusiness.dragonforms.com/loading.do?omedasite=aqua_pref',
  ...
  wfb: {
    ...
    subscribeLink: 'https://athleticbusiness.dragonforms.com/loading.do?omedasite=wfb_pref',
    privacyPolicyLink: 'https://www.woodfloorbusiness.com/page/privacy-policy',
